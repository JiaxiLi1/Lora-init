#!/usr/bin/env python3
"""
快速下载 facebook/dinov3-vitb16-pretrain-lvd1689m 模型到指定目录
支持多种下载方式和加速选项
"""
...
def download_with_huggingface_hub():
    ...
    try:
        ...
        # 目标目录
        target_dir = "/home/rtx3090/code_jiaxi/LORO-main_temp/file_jinjin/dinov3-vitb16-pretrain-lvd1689m"
...
def download_with_git_lfs():
    ...
    model_dir = os.path.join(target_dir, "dinov3-vitb16-pretrain-lvd1689m")
    ...
    clone_cmd = f"""
cd {target_dir} && \
git clone https://huggingface.co/facebook/dinov3-vitb16-pretrain-lvd1689m
"""
...
def main():
    ...
    if success:
        print("\n🎉 模型下载成功！")
        print("\n📋 下载的文件:")
        model_path = os.path.join(target_base, "dinov3-vitb16-pretrain-lvd1689m")
